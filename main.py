...
from astrbot.api import event                    # ✅ 正确导入 event
from astrbot.api.event import filter, command   # ✅ 正确导入 filter 和 command
...
# ========== 插件主类 ==========
@register("astrbot_plugin_kuwo", "YourName", "酷我音乐管理", "1.0.1", "https://github.com/YourName/astrbot_plugin_kuwo")
