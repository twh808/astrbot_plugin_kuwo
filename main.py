...
# 3. AstrBot 插件主类
# ======================================================================
@register("astrbot_plugin_kuwo", "YourName", "酷我音乐管理", "1.1.5", "https://github.com/YourName/astrbot_plugin_kuwo")
