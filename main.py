...
from astrbot.api.all import *   # 包含 command, filter, register, Star, Context, AstrMessageEvent 等
...
# 插件主类
# ======================================================================
@register("astrbot_plugin_kuwo", "YourName", "酷我音乐管理", "1.0.6", "https://github.com/YourName/astrbot_plugin_kuwo")
