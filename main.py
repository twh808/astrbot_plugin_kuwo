...
# ======================================================================
# 3. AstrBot 插件主类（完整功能 + 管理员面板，修复消息重复处理）
# ======================================================================
class KuwoPlugin(Star):
    ...
    async def initialize(self):
        logger.info("✅ 酷我插件 2.4.2 修复消息重复处理版已加载")
