...
# ========== 正确导入装饰器 ==========
from astrbot.api import event          # 监听所有消息的装饰器
from astrbot.api.all import *          # command, register, Star, Context, AstrMessageEvent 等
...
# 插件主类
# ======================================================================
@register("astrbot_plugin_kuwo", "YourName", "酷我音乐管理", "1.0.7", "https://github.com/YourName/astrbot_plugin_kuwo")
